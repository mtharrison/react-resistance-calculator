...
/***/ function(module, exports, __webpack_require__) {
	...
	var _ResistanceCalculator = __webpack_require__(159);

	var _ResistanceCalculator2 = _interopRequireDefault(_ResistanceCalculator);
	...
	(0, _reactDom.render)(_react2.default.createElement(_ResistanceCalculator2.default, { config: config }), document.getElementById('container'));
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _BandSelector = __webpack_require__(160);

	var _BandSelector2 = _interopRequireDefault(_BandSelector);

	var _OhmageIndicator = __webpack_require__(161);

	var _OhmageIndicator2 = _interopRequireDefault(_OhmageIndicator);

	var _ResetButton = __webpack_require__(162);

	var _ResetButton2 = _interopRequireDefault(_ResetButton);

	var _SVGResistor = __webpack_require__(163);

	var _SVGResistor2 = _interopRequireDefault(_SVGResistor);

	var _ToleranceIndicator = __webpack_require__(164);

	var _ToleranceIndicator2 = _interopRequireDefault(_ToleranceIndicator);
	...
	var ResistanceCalculator = (function (_Component) {
	    _inherits(ResistanceCalculator, _Component);

	    function ResistanceCalculator(props) {
	        _classCallCheck(this, ResistanceCalculator);

	        var _this = _possibleConstructorReturn(this, Object.getPrototypeOf(ResistanceCalculator).call(this, props));

	        _this.state = {
	            bands: props.config.bands.map(function (v) {
	                return v.value || 0;
	            }),
	            resistance: 0,
	            tolerance: 0
	    ...
	    _createClass(ResistanceCalculator, [{
	        key: 'getMultiplier',
	        value: function getMultiplier() {
	            if (this.state.bands[3] == 10) return 0.1;
	            if (this.state.bands[3] == 11) return 0.01;
	            return Math.pow(10, this.state.bands[3]);
	        }
	    }, {
	        key: 'calculateResistance',
	        value: function calculateResistance() {
	            return this.getMultiplier() * (100 * this.state.bands[0] + 10 * this.state.bands[1] + 1 * this.state.bands[2]);
	        }
	    }, {
	        key: 'updateBandState',
	        ...
	        value: function render() {
	            ...
	            var bandOptions = _props$config.bandOptions;
	            var bandsConfig = _props$config.bands;
	            var _state = this.state;
	            var bands = _state.bands;
	            var resistance = _state.resistance;
	            var tolerance = _state.tolerance;

	            return _react2.default.createElement(
	                'div',
	                null,
	                _react2.default.createElement(_SVGResistor2.default, { bands: bands, bandOptions: bandOptions }),
	                _react2.default.createElement(_OhmageIndicator2.default, { resistance: resistance }),
	                _react2.default.createElement(_ToleranceIndicator2.default, { tolerance: tolerance }),
	                bands.map(function (b, i) {
	                    var options = bandOptions.filter(function (b, j) {
	                        return bandsConfig[i].omitOptions.indexOf(j) === -1;
	                    });
	                    return _react2.default.createElement(_BandSelector2.default, {
	                        options: options,
	                        key: i,
	                        band: i,
	                        value: b,
	                        onChange: _this2.updateBandState.bind(_this2)
	                    });
	                }),
	                _react2.default.createElement(_ResetButton2.default, { onClick: this.reset.bind(this) })
	            );
	        }
	    }]);
	...
	exports.default = ResistanceCalculator;
...
/***/ function(module, exports, __webpack_require__) {
	...
	var BandSelector = (function (_Component) {
	    _inherits(BandSelector, _Component);

	    function BandSelector(props) {
	        _classCallCheck(this, BandSelector);

	        return _possibleConstructorReturn(this, Object.getPrototypeOf(BandSelector).call(this, props));
	    }

	    _createClass(BandSelector, [{
	        key: "handleChange",
	        ...
	        value: function render() {
	            ...
	            return _react2.default.createElement(
	                ...
	                _react2.default.createElement(
	                    "select",
	                    { ref: "menu", value: value, onChange: this.handleChange.bind(this) },
	...
	BandSelector.propTypes = {
	    ...
	    band: _react2.default.PropTypes.number.isRequired,
	    options: _react2.default.PropTypes.array.isRequired,
	    value: _react2.default.PropTypes.number.isRequired
	};

	exports.default = BandSelector;
...
/***/ function(module, exports, __webpack_require__) {
	...
	var OhmageIndicator = function OhmageIndicator(_ref) {
	    var resistance = _ref.resistance;

	    var formatResistance = function formatResistance() {
	        var r = parseFloat(resistance);
	        var MILLION = 1000000;
	        var THOUSAND = 1000;

	        if (r > MILLION) return (r / MILLION).toFixed(1) + "MΩ";
	        if (r > THOUSAND) return (r / THOUSAND).toFixed(1) + "KΩ";
	...
	OhmageIndicator.propTypes = {
	    resistance: _react2.default.PropTypes.number.isRequired
	};

	exports.default = OhmageIndicator;
...
/***/ function(module, exports, __webpack_require__) {
	...
	var ResetButton = function ResetButton(_ref) {
	    ...
	    return _react2.default.createElement(
	        "button",
	        { className: "reset-button", onClick: onClick },
	        "Reset All"
	    );
	};
...
/***/ function(module, exports, __webpack_require__) {
	...
	var SVGResistor = function SVGResistor(_ref) {
	    var bands = _ref.bands;
	    var bandOptions = _ref.bandOptions;

	    var bandPositions = [70, 100, 130, 160, 210];
	    return _react2.default.createElement(
	        "svg",
	        { width: 300, height: 100, version: "1.1", xmlns: "http://www.w3.org/2000/svg" },
	        _react2.default.createElement("rect", { x: 0, y: 26, rx: 5, width: 300, height: 7, fill: "#d1d1d1" }),
	        _react2.default.createElement("rect", { x: 50, y: 0, rx: 15, width: 200, height: 57, fill: "#FDF7EB" }),
	        bands.map(function (b, i) {
	...
	SVGResistor.propTypes = {
	    bands: _react2.default.PropTypes.array.isRequired,
	    bandOptions: _react2.default.PropTypes.array.isRequired
	};

	exports.default = SVGResistor;
...
/***/ function(module, exports, __webpack_require__) {
	...
	var ToleranceIndicator = function ToleranceIndicator(_ref) {
	    var tolerance = _ref.tolerance;

	    var formatTolerance = function formatTolerance() {
	...
	ToleranceIndicator.propTypes = {
	    tolerance: _react2.default.PropTypes.number.isRequired
	};
